...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.manageBranch.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.manage-branches.update", [$manageBranch->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')

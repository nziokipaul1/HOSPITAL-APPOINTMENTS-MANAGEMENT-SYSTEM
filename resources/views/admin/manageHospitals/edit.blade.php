...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.manageHospital.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.manage-hospitals.update", [$manageHospital->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
